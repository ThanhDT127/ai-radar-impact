...
async def list_insights(
    ...
    intelligence_tier: str | None = Query(
        default=None,
        description="Comma-separated intelligence tiers (Tactical,Operational,Strategic,Informational)",
    ),
    sort_by: str = Query(
        default="urgency",
    ...
    tier_list = (
        [v.strip() for v in intelligence_tier.split(",") if v.strip()]

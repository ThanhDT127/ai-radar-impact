...
INITIAL_SOURCES = [
    ...
    # Experimental Social Media Sources (Playwright/CloakBrowser benchmark)
    {
        ...
        "config": {
            ...
            "wait_for": "article",
            "max_items": 5,
            "cookie_file": "/secrets/states/x_state.json",
            "auto_scroll_count": 1,
        },
    },
    {
        "name": "X (Twitter) - Anthropic",
        "source_type": "playwright",
        "feed_url": "https://x.com/AnthropicAI",
        "trust_tier": "very_high",
    ...
    },
    {
        ...
        "source_type": "playwright",
        "feed_url": "https://www.linkedin.com/company/anthropic/posts/",
        "trust_tier": "very_high",
        "topics": ["Trí tuệ nhân tạo", "An ninh mạng"],
        "status": "active",
        "region": "global",
    ...
    {
        "name": "X (Twitter) - Project Zero (Google)",
        "source_type": "playwright",
        "feed_url": "https://x.com/ProjectZero",
        "trust_tier": "very_high",
        "topics": ["An ninh mạng"],
        "status": "active",
        "region": "global",
    ...
    {
        "name": "X (Twitter) - Kelsey Hightower",
        "source_type": "playwright",
        "feed_url": "https://x.com/kelseyhightower",
        "trust_tier": "high",
        "topics": ["Công nghệ", "Quy trình phần mềm"],
        "status": "active",
        "region": "global",

...
Gửi bản tin insight tới người nhận qua Gmail (SMTP + App Password), thay cho transport Telegram đã gỡ
21/07/2026. Bao gồm: adapter SMTP, render email HTML + plain-text, định danh người nhận bằng địa chỉ
email, quản lý người nhận trên dashboard, và hủy nhận từ trong email.

Engine chọn tin và nhịp gửi nằm ở capability `delivery-engine` — capability này chỉ lo phần vận
chuyển và danh sách người nhận.

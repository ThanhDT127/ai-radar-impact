...
Cào nội dung từ nguồn mạng xã hội (LinkedIn) — nơi bài viết nằm trong thẻ feed do JavaScript render và
bị chặn xem khi ẩn danh. Capability này phủ: trích nội dung thẳng từ thẻ feed (không cần mở trang chi
tiết), giới hạn auto-scroll, và vòng đời phiên đăng nhập (nạp → phát hiện login-wall → gia hạn).
## Requirements
...
Hệ thống MUST có khả năng cuộn trang (simulate human scroll) một số lần giới hạn để load bài đăng cũ trên MXH mà không bị khóa tài khoản do hành vi spam.
